...
const Dashboard = () => {
    ...
    try {
        ...
        setNewProject({ name: '', description: '' }); // Form reset karein
        fetchProjects(); // List refresh karein
    } catch (error) {
        alert("Project nahi ban paya!");
    }
};
    ...
    return (
        <div className="min-h-screen bg-linear-to-br from-slate-50 via-blue-50/30 to-purple-50/20 flex text-[#1A1A1A] antialiased">
            ...
            <main className="flex-1 ml-70">
                ...
                <div className="p-10 max-w-7xl mx-auto">
                    ...
                    {user.role === 'ADMIN' && (
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
                            {/* Total Projects */}
                            <div className="bg-linear-to-br from-blue-50 to-blue-100 p-6 rounded-3xl border border-blue-200/50 shadow-sm hover:shadow-md transition-all">
                            ...
                            {/* Total Tasks */}
                            <div className="bg-linear-to-br from-purple-50 to-purple-100 p-6 rounded-3xl border border-purple-200/50 shadow-sm hover:shadow-md transition-all">
                                <div className="flex items-center justify-between mb-4">
                                    <div className="w-12 h-12 bg-white rounded-2xl flex items-center justify-center shadow-sm">
                            ...
                            {/* Team Members */}
                            <div className="bg-linear-to-br from-green-50 to-green-100 p-6 rounded-3xl border border-green-200/50 shadow-sm hover:shadow-md transition-all">
                                <div className="flex items-center justify-between mb-4">
                                    <div className="w-12 h-12 bg-white rounded-2xl flex items-center justify-center shadow-sm">
                            ...
                            {/* Completed Tasks */}
                            <div className="bg-linear-to-br from-amber-50 to-amber-100 p-6 rounded-3xl border border-amber-200/50 shadow-sm hover:shadow-md transition-all">
                                <div className="flex items-center justify-between mb-4">
                                    <div className="w-12 h-12 bg-white rounded-2xl flex items-center justify-center shadow-sm">
                ...
                {isModalOpen && (
                    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-6">
                        <div className="bg-white w-full max-w-lg rounded-3xl p-8 shadow-2xl border border-gray-100 animate-in fade-in zoom-in duration-200">
                        ...
                        <div className="bg-white w-full max-w-lg rounded-3xl p-8 shadow-2xl border border-gray-100">
                            ...
                            <form onSubmit={handleCreateTask} className="space-y-6">
                                ...
                                <div>
                                    ...
                                    {users.length === 0 && (
                                        <p className="text-xs text-gray-500 mt-2">No team members found. Please ensure members have signed up.</p>
                                    )}
                                </div>
                ...
                <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-6">
                    <div className="bg-white w-full max-w-md rounded-3xl p-8 shadow-2xl border border-gray-100">
                        <div className="flex flex-col items-center text-center">
                            ...
                            <p className="text-sm text-gray-500 mb-8">This action cannot be undone. All tasks associated with this project will also be affected.</p>
